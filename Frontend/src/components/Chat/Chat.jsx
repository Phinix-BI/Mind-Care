...
const Chat = () => {
  return (
    <div className='flex w-100vh'> {/* Apply background color to the entire chat interface */}
      {/* <NavBar /> Render the NavBar component */}
      <div className='max-w-screen-xl mx-auto'>
        {/* Welcome Note */}
        <div className='text-center p-4'>
            <h1 className='text-3xl p-4 font-semibold'>Welcome to your AI Therapy Session</h1>
            <p className='text-lg font-medium text-gray-500 border-2 rounded-xl p-2'>I'm here to provide support and assistance as you navigate through life's 
